        ...
        <Row>
            <Col md={1} xs={3}>
                <FormGroup controlId="formControlsSelect">
                    ...
                    <FormControl componentClass="select" placeholder="Month" onChange={props.changedFromMonth} value={props.fromMonth}>
            ...
            <Col md={1} xs={3}>
                <FormGroup controlId="formControlsSelect">
                    <FormControl componentClass="select" placeholder="Month" onChange={props.changedToMonth} value={props.toMonth}>
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
                        <option value="4">4</option>
            ...
            <Col md={1} xs={5}>
                <FormGroup controlId="formControlsSelect">
                    <FormControl componentClass="select" placeholder="Year" onChange={props.changedYear} value={props.year}>
